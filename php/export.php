<?php// Connect and query the database for the users
include 'utils.php';
...
$filename = "tmp/".$bookName.".tsv";// Remember that the folder where you want to write the file has to be writable
...
fputcsv($handle, array(`last_name`,`first_name`,`city`,`state`,`zip`,`phone`,`email`,`address_1`,`address_2`), "/t");
